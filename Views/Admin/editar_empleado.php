                ...
                <div class="row">
                    ...
                    <div class="card">        
                            <div class="card-body">                  
                                ...
                                <form action="../../empleados/update" method="POST" class="mt-5" id="form">
                                <?php  while( $row = sqlsrv_fetch_array( $data['empleado'], SQLSRV_FETCH_ASSOC) ) { ?>
                                    <input id="modificar" type="hidden" name="id" value="<?= $row['id']; ?>">

                                    <div class="row my-4">
                                        <div class="col">
                                            <input type="text" name="nombre" class="form-control border border-secondary" value="<?= $row['nombre']; ?>">
                                        </div>
                                        <div class="col">
                                            <input type="text" name="apellidos" class="form-control border border-secondary" value="<?= $row['apellidos']; ?>">
                                        </div>
                                    </div>
                                    <div class="row my-4">
                                        <div class="col">
                                            <input type="text" name="dni" class="form-control border border-secondary" value="<?= $row['dni']; ?>">
                                        </div>
                                        <div class="col">
                                            <input type="text" name="celular" class="form-control border border-secondary" value="<?= $row['celular']; ?>">
                                        </div>
                                    </div>
                                    <div class="row my-4">
                                        <div class="col">
                                            <textarea class="form-control border border-secondary" name="direccion" id="exampleFormControlTextarea1" rows="3"><?= $row['direccion']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row my-4">
                                        <div class="col">
                                            <input type="text" class="form-control border border-secondary" name="email" value="<?= $row['email']; ?>">
                                        </div>
                                        <div class="col">
                                            <input type="text" class="form-control border border-secondary" name="pass" value="<?= $row['pass']; ?>">
                                        </div>
                                    </div>
                                    <div class="col">
                                            ...
                                            <?php
                                                while( $row = sqlsrv_fetch_array( $data['rol'], SQLSRV_FETCH_ASSOC) ) {
